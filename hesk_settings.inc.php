...
$hesk_settings['language']='Français';
$hesk_settings['languages']=array(
'English' => array('folder'=>'en','hr'=>'------ Reply above this line ------'),
'Français' => array('folder'=>'fr','hr'=>'------ Répondre au-dessous de cette ligne ------'),
);
...
$hesk_settings['hesk_url']='http://localhost/hesk';
...
$hesk_settings['cat_show_select']=10;

// --> SPAM Prevention
$hesk_settings['secimg_use']=1;
$hesk_settings['secimg_sum']='9W6GRZZ5SH';
...
$hesk_settings['question_ask']='What is the next number after 3? (Use only digits to answer)';
...
#     DO NOT EDIT BELOW     #
#############################
$hesk_settings['hesk_version']='2.7.1';
